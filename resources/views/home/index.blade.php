...
<link href='homes/css/css.css' rel='stylesheet' type='text/css'>
		...
		<div class="header" id="home">
			...
			<div class="header-banner">
					...
					<section class="col-3 ss-style-doublediagonal our-features">
							<div class="container"> 
							<h2>Our features</h2>
							<p>Paragraphs lorem ipsum simply a dummy text to format fonts and</p>
				...
				</div><div class="copyrights">Collect from <a href="http://www.17sucai.com/" >企业网站模板</a></div>
				<div class="index-abt">
					<div class="container">
						<div class="col-md-3 index-abt1">
							<div class="abt-img"><i class="glyphicon glyphicon-euro"> </i></div>
								<h3>Voluptatem</h3>
								<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem.</p>
...
<div class="index-p">
	<div class="container">
		<div class="col-md-6 green-gird">
			<img src="homes/images/index-p.jpg"  alt=""/>
			<img src="homes/images/index-p1.jpg" alt="" />
		</div>
				...
				<div class="col2">
					<div class="col-md-4 col1">
						<figure class="effect-bubba">
							<img class="img-responsive" src="homes/images/we.jpg" alt=""/>
							<figcaption>
					...
					<div class="col-md-4 col1">
						<figure class="effect-bubba">
							<img class="img-responsive" src="homes/images/we1.jpg" alt=""/>
							<figcaption>
						    <h4>Enimet pulvinar posuere</h4>
								<p>In sit amet sapien eros Integer dolore magna aliqua</p>	
							</figcaption>			
					...
					<div class="col-md-4 col1">
						<figure class="effect-bubba">
							<img class="img-responsive" src="homes/images/w32.jpg" alt=""/>
							<figcaption>
						    <h4>Enimet pulvinar posuere</h4>
								<p>In sit amet sapien eros Integer dolore magna aliqua</p>	
							</figcaption>			
